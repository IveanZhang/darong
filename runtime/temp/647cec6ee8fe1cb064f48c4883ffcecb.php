<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:99:"/Users/ivanzhang/Documents/git-workspace/darong/public/../application/index/view/index/contact.html";i:1548888441;s:89:"/Users/ivanzhang/Documents/git-workspace/darong/application/index/view/layout/darong.html";i:1549903753;s:89:"/Users/ivanzhang/Documents/git-workspace/darong/application/index/view/common/script.html";i:1548799606;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a href="/index/index/city.html" class="nav-link">热门城市</a></li>
    ...
    <div class="container">
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-9 ftco-animate text-center" data-scrollax=" properties: { translateY: '70%' }">
          <p class="breadcrumbs" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }"><span class="mr-2"><a href="/index/index/index.html">首页</a></span> <span>联系我们</span></p>
    ...
    <div class="container">
      <div class="row d-flex mb-5 contact-info">
        ...
        <div class="w-100"></div>
        <div class="col-md-3">
          <p><span>地址:</span> 250 Sheppard Ave East. North York, Ontario, Canada</p>
        </div>
        <div class="col-md-3">
          <p><span>电话:</span> <a href="tel://1234567920">+1(416)-224-0386</a></p>
        </div>
        <div class="col-md-3">
          <p><span>Email:</span> <a href="mailto:info@yoursite.com">wuzhou331@gmail.com</a></p>
        </div>
        <div class="col-md-3">
          <p><span>网址</span> <a href="#">www.uuwill.vip</a></p>
        </div>
      </div>
      <div class="row block-9">
        <div class="col-md-6 pr-md-5">
          <form action="#">
            ...
            <div class="form-group">
              <input type="text" class="form-control" placeholder="你的邮件">
            </div>
            <div class="form-group">
              <input type="text" class="form-control" placeholder="主题">
            </div>
            <div class="form-group">
              <textarea name="" id="" cols="30" rows="7" class="form-control" placeholder="消息内容"></textarea>
            </div>
            <div class="form-group">
