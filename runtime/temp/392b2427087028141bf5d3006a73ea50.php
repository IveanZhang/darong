<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"/Users/ivanzhang/Documents/git-workspace/darong/public/../application/admin/view/news/news/edit.html";i:1550011196;s:90:"/Users/ivanzhang/Documents/git-workspace/darong/application/admin/view/layout/default.html";i:1548799606;s:87:"/Users/ivanzhang/Documents/git-workspace/darong/application/admin/view/common/meta.html";i:1548968088;s:89:"/Users/ivanzhang/Documents/git-workspace/darong/application/admin/view/common/script.html";i:1548799606;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Descp'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-descp" data-rule="required" class="form-control" name="row[descp]" type="text"
                value="<?php echo $row['descp']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-content" data-rule="required" class="form-control editor" rows="5" name="row[content]"
