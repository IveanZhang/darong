<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:100:"/Users/ivanzhang/Documents/git-workspace/darong/public/../application/admin/view/tour/tour/edit.html";i:1549579118;s:90:"/Users/ivanzhang/Documents/git-workspace/darong/application/admin/view/layout/default.html";i:1548799606;s:87:"/Users/ivanzhang/Documents/git-workspace/darong/application/admin/view/common/meta.html";i:1548968088;s:89:"/Users/ivanzhang/Documents/git-workspace/darong/application/admin/view/common/script.html";i:1548799606;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-img" data-rule="required" class="form-control" size="50" name="row[img]" type="text" value="<?php echo $row['img']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-group_id" data-rule="required" data-source="tour/group/index" class="form-control selectpage"
                name="row[group_id]" type="text" value="<?php echo $row['group_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-country_id" data-rule="required" data-source="country/index" class="form-control selectpage"
                name="row[country_id]" type="text" value="<?php echo $row['country_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-ishot" data-rule="required" class="form-control selectpicker" name="row[ishot]">
                ...
                <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['ishot'])?$row['ishot']:explode(',',$row['ishot']))): ?>selected<?php endif; ?>><?php echo $vo; ?> </option> <?php endforeach; endif; else: echo "" ;endif; ?> </select>
            ...
            <div class="col-xs-12 col-sm-8">
                ...
                <div class="radio">
                    ...
                    <label for="row[status]-<?php echo $key; ?>"><input id="row[status]-<?php echo $key; ?>" name="row[status]" type="radio"
                            value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['status'])?$row['status']:explode(',',$row['status']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                ...
                <div class="radio">
                    ...
                    <label for="row[rate]-<?php echo $key; ?>"><input id="row[rate]-<?php echo $key; ?>" name="row[rate]" type="radio" value="<?php echo $key; ?>"
                            <?php if(in_array(($key), is_array($row['rate'])?$row['rate']:explode(',',$row['rate']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </div>
            </div>
        </div>
