<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"/Users/ivanzhang/Documents/workspace/fastadmin/public/../application/index/view/index/index.html";i:1548802141;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="tour.html" class="nav-link">热门线路</a></li>
          <li class="nav-item"><a href="hotel.html" class="nav-link">热门城市</a></li>
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                ...
                <div class="fields d-block d-flex">
                  ...
                  <div class="select-wrap one-third">
                    ...
                    <select name="" id="" class="form-control" placeholder="Keyword search">
                      ...
                      <option value="">多伦多</option>
                      <option value="">温哥华</option>
                      <option value="">蒙特利尔</option>
                    </select>
                  </div>
                </div>
            ...
            <p class="browse d-md-flex">
            	<span class="d-flex justify-content-md-center align-items-md-center"><a href="#"><i class="flaticon-fork"></i>跟团游</a></span>
            	<span class="d-flex justify-content-md-center align-items-md-center"><a href="#"><i class="flaticon-hotel"></i>私人订制</a></span> 
            	<span class="d-flex justify-content-md-center align-items-md-center"><a href="#"><i class="flaticon-meeting-point"></i>冬夏令营</a></span> 
            	<span class="d-flex justify-content-md-center align-items-md-	center"><a href="#"><i class="flaticon-shopping-bag"></i>邮轮之旅</a></span>
            </p>
          </div>
        </div>
      </div>
...
<!--     <section id="about-us" class='overlay'>
    				...
    				<div class="destination-slider owl-carousel ftco-animate">
    					<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/destination-1.jpg);">
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/destination-2.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							<span class="icon-search2"></span>
		    						</div>
		    					</a>
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/destination-3.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							<span class="icon-search2"></span>
		    						</div>
		    					</a>
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/destination-4.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							<span class="icon-search2"></span>
		    						</div>
		    					</a>
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/destination-5.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							<span class="icon-search2"></span>
		    						</div>
		    					</a>
	    				...
	    				<div class="item">
		    				<div class="destination">
		    					<a href="#" class="img d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/destination-6.jpg);">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							<span class="icon-search2"></span>
		    						</div>
		    					</a>
    ...
    <section class="ftco-section bg-light">
      ...
      <div class="button-group filter-button-group">
        <button class="btn btn-primary active" data-filter=".camp">夏/冬令营</button>
        <button class="btn btn-primary" data-filter=".group-tour">跟团游</button>
        <button class="btn btn-primary" data-filter=".customized">高端定制游</button>
        <button class="btn btn-primary" data-filter=".theme">主题游</button>
      </div>

    	<div class="container">
    		<div class="grid row">
    			<div class="grid-item col-3 camp">
    				<div class="grid-item-content destination">
    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/hotel-1.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    					<div class="text p-3">
    						...
    						<p class="bottom-area d-flex">
    							...
    							<span class="ml-auto"><a href="#">查看详情</a></span>
    						</p>
    					</div>
    				</div>
    			</div>
    			<div class="grid-item col-3 group-tour group-tour">
    				<div class="grid-item-content destination">
    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/hotel-2.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    			...
    			<div class="grid-item col-3 group-tour theme">
    				<div class="grid-item-content destination">
    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/hotel-3.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    			...
    			<div class="grid-item col-3 customized">
    				<div class="grid-item-content destination">
    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/hotel-4.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    			...
    			<div class="grid-item col-3 theme">
    				<div class="grid-item-content destination">
    					<a href="#" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(/assets/img/images/hotel-5.jpg);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">250 Sheppard Ave East, North York, Ontario, CA</span></li>
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+1 (416)-224-0386</span></a></li>
  ...
  <!-- <script src="/assets/js/https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
