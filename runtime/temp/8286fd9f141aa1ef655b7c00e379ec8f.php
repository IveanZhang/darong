...
<script type="text/javascript">
    ...
    <div class="form-group-seperator" data-index="<?php echo $vo['id']; ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-8">
                ...
                <ul class="row list-inline plupload-preview" id="p-image<?php echo $vo['id']; ?>"></ul>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-xs-12 text-center">
                <button type="button" data-index="<?php echo $vo['id']; ?>" class="btn btn-danger btn-delone"><?php echo __('Delete'); ?></button>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-xs-12 text-center">
            <button type="button" class="btn btn-info btn-addone"><?php echo __('Add'); ?></button>
        </div>
    </div>
    ...
    <div class="form-group layer-footer">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <span class="btn btn-default btn-embossed btn-refresh"><?php echo __('Refresh'); ?></span>
        </div>
    </div>
